...
print("Elemento en la posicion 2:", accederPosicion(p, 1))
print("Elemento en la posicion 2:", accederPosicion(p, 0))
print("Elemento en la posicion 2:", accederPosicion(p, 3))# Debería imprimir 30
