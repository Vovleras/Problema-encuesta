...
def mayor_menor_pregunta_opinion(tema,tipo):
    ...
    if 'opinion' == tipo:
        max =  accederPosicion(accederPosicion(tema,0),0).promedio_opinion
        min =  accederPosicion(accederPosicion(tema,0),0).promedio_opinion
    else:
        max =  accederPosicion(accederPosicion(tema,0),0).promedio_experticia
        min =  accederPosicion(accederPosicion(tema,0),0).promedio_experticia
    ...
    for i in range(tema.top+1):
        for j in range ( (accederPosicion(tema,i).top)+1):
            if 'opinion' == tipo:
                if max < accederPosicion(accederPosicion(tema,i),j).promedio_opinion:
                    max = accederPosicion(accederPosicion(tema,i),j).promedio_opinion
                if accederPosicion(accederPosicion(tema,i),j).promedio_opinion < min:
                    min = accederPosicion(accederPosicion(tema,i),j).promedio_opinion
            else:
                if max < accederPosicion(accederPosicion(tema,i),j).promedio_experticia:
                    max = accederPosicion(accederPosicion(tema,i),j).promedio_experticia
                if accederPosicion(accederPosicion(tema,i),j).promedio_experticia < min:
                    min = accederPosicion(accederPosicion(tema,i),j).promedio_experticia
...
def obtener_resultado(nombre):
    ...
    mayor_menor_pregunta_opinion(pila_temas,'opinion')
    mayor_menor_pregunta_opinion(pila_temas,'experticia')
    
    print("temas_organizados")
    print(pila_temas)
