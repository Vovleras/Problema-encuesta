...
#funcion que recibe una pila de tema y organiza los encuestados de cada tema
...
def ordenar_encuestados_preg(tema):
    ...
    for i in range(tema.top+1):
        for j in range ( (accederPosicion(tema,i).top)+1):
            QUICKSORT(accederPosicion(accederPosicion(tema,i),j), 0, )
            print(accederPosicion(accederPosicion(tema,i)))
