...
def obtener_resultado(nombre):
    ...
    print(f"Encuestado con mayor opinion: ({accederPosicion(m_n_e_o, 0).id}, {accederPosicion(m_n_e_o, 0).nombre}, {accederPosicion(m_n_e_o, 0).opinion},{accederPosicion(m_n_e_o, 0).experticia})")
    print(f"Encuestado con menor opinion: ({accederPosicion(m_n_e_o, 1).id}, {accederPosicion(m_n_e_o, 1).nombre}, {accederPosicion(m_n_e_o, 1).opinion},{accederPosicion(m_n_e_o, 1).experticia})")
    print(f"Encuestado con mayor experticia: ({accederPosicion(m_n_e_e, 0).id}, {accederPosicion(m_n_e_e, 0).nombre}, {accederPosicion(m_n_e_e, 0).opinion},{accederPosicion(m_n_e_e, 0).experticia})")
    print(f"Encuestado con menor experticia: ({accederPosicion(m_n_e_e, 1).id}, {accederPosicion(m_n_e_e, 1).nombre}, {accederPosicion(m_n_e_e, 1).opinion},{accederPosicion(m_n_e_e, 1).experticia})")
