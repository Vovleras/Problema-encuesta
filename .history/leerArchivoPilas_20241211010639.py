...
#funcion que recibe una lista de temas y organiza las preguntas de cada tema
...
#funcion que recibe una lista de preguntas y organiza los encuestados de cada tema

def ordenar_encuestados_preg(preguntas):
    for i in range(preguntas.top+1):
