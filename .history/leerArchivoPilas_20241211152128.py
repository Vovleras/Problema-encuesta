...
def obtener_resultado(nombre):
    ...
    mostra_info(pila_encuestados, pila_temas, m_n_e_e, m_n_e_o)
    
    print("Lista de encuestados:")
    for i in range(pila_encuestados.top+1):
        print(f"({accederPosicion(pila_encuestados,i).id}, Nombre:'{accederPosicion(pila_encuestados,i).nombre}', Experticia:{accederPosicion(pila_encuestados,i).experticia}, Opinion:{accederPosicion(pila_encuestados,i).opinion})")
