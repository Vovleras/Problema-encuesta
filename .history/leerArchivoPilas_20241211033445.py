...
#funcin que recibe tema y retorna el encuesta maximo y minimo segun el tipo
def mayor_menor_pregunta_opinion(tema,tipo):
    

    max =  accederPosicion(accederPosicion(tema,0).preguntas.encuestados,0)
    min =  accederPosicion(accederPosicion(tema,0).preguntas.encuestados,0)
...
def obtener_resultado(nombre):
    ...
    ordenar_temas = QUICKSORT(pila_temas,0,pila_temas.top)
