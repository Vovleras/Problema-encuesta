...
#y en la segunda posicion tiene una lista de temas que a su vez tiene una lista de preguntas que contiene el indice
# de los encuestados que respondieron la pregunta.
...
#funcion que recibe una lista de temas
#Retorna las preguntas ordenadas de cada tema
