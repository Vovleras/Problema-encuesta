...
def obtener_resultado(nombre):
    ...
    print(f"Pregunta con mayor promedio de experticia: [{accederPosicion(m_n_e, 0).promedio_opinion}] {accederPosicion(m_n_o, 0).nombre}")
    print(f"Pregunta con menor promedio de experticia: [{accederPosicion(m_n_e, 1).promedio_opinion}] {accederPosicion(m_n_o, 0).nombre}")
